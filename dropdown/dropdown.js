(function($) {
    ...
    $.fn.fSelect = function(options) {
        ...
        fSelect.prototype = {
            create: function() {
                ...
                this.$select.before('<div class="fs-label-wrap"><div class="fs-label" lay-verify="through">' + this.settings.placeholder + '</div><span class="fs-arrow"></span></div>');
                this.$select.before('<div class="fs-dropdown hidden"><div class="fs-options"></div></div>');
                // this.$select.addClass('hidden');
                this.$select.addClass('visibility-hidden');
                this.$wrap = this.$select.closest('.fs-wrap');
                //添加全选和清空按钮
                var BtnFixed = '<div class="btnFixed"><button class="buttonDefault" id="selectAllBtn" type="button">全选</button>' +
                    '<button class="buttonDefault" id="clearAllBtn" type="button">清空</button><button class="buttonDefault" id="buttonSure" type="button">确定</button></div>';
            ...
            reloadDropdownLabel: function() {
                ...
                this.$wrap.find('.fs-option.selected').each(function(i, el) {
                    ...
                    labelIds.push($(el).attr('data-value'));
                });
                ...
                settings.selectVal=labelIds;


                this.$wrap.find('.fs-label').html(labelText);
                this.$wrap.find('.fs-label').attr("title",labelIds);
                this.$select.change();
    ...
    //点击确定 关闭下拉框
    $(document).on('click','#buttonSure', function(e) {
        $('.fs-dropdown').addClass('hidden');
        window.fSelect.active = null;
    });
